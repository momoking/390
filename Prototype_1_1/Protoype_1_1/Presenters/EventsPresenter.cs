...
namespace Prototype1_1.Presenters
{
    class EventsPresenter
    {
        ...
        private void AttachEventHandlers()
        {
            ...
            _view.btnDeleteAll.Click += DeleteAllEvents;
        }
        ...
        void DeleteEvent(object sender, EventArgs e)
        {
            ...
            {
                @event toRemove = _entities.@event.Where(ev => ev.Name == selectedEvent.Text && ev.Start == selectedEvent.StartDate && ev.End == selectedEvent.EndDate).First();
                if (toRemove != null)
                {
        ...
        void DeleteAllEvents(object sender, EventArgs e)
        {
            CalendarItem selectedEvent = _view.calendar.GetSelectedItems().First();
            if (selectedEvent != null)
            {
